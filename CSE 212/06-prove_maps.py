...
def is_anagram(word1, word2):
    ...
    wordTwo = dict()
    for letter in word1:
        if letter.lower() in wordOne:
            wordOne[letter.lower()] = wordOne[letter.lower()] +1
        else:
            wordOne[letter.lower()] = 1
    for letter in word2:
        if letter.lower() in wordTwo:
            wordTwo[letter.lower()] = wordTwo[letter.lower()] +1
        else:
            wordTwo[letter.lower()] = 1
    try:
        del wordOne[" "]
        del wordTwo[" "]
    except:
